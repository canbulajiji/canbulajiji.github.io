...
(function () {
  ...
  window.needShareButton = function (elem, options) {
    ...
    root.share = {
      ...
      "wechat": function (el) {
        var myoptions = getOptions(el);
        var imgSrc = "http://qr.liantu.com/api.php?logo=https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=302639002,620934371&fm=26&gp=0.jpg&text=" + encodeURIComponent(myoptions.url);
